                ...
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            ...
                            <h1 class="m-0"> <box-icon name='medium-square' type='logo' color='#e24141'></box-icon></h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                    ...
                    <div id="agrupar">
                        ...
                        if (isset($_REQUEST["id"])) {
                            switch ($_REQUEST["id"]) {
                                case 1:
                        ?>
                                    <form action="../controlador/ctrlMesa.php" method="post" id="registro-form">
                                        <div class="form-group">
                                            <label for="numero_mesa">Número de Mesa</label>
                                            <input type="number" id="numero_mesa" name="numero_mesa" min="0" max="999" required>
                                            <div class="error-message" id="numero_mesa-error"></div>
                                        </div>
                                        <div class="form-group">
                                            <label for="cantidad">Cantidad</label>
                                            <input type="number" id="cantidad" name="cantidad" min="0" max="99999999" required>
                                            <div class="error-message" id="cantidad-error"></div>
                                        </div>
                                        <div class="form-group">
                                            <label for="disponibilidad">Disponibilidad</label>
                                            <select id="disponibilidad" name="disponibilidad" required>
                                                <option value="Esta disponible">Sí</option>
                                                <option value="No esta disponible">No</option>
                                            </select>
                                            <div class="error-message" id="disponibilidad-error"></div>
                                        </div>
                                        <div class="form-group">
