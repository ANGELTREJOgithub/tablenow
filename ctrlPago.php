        ...
        <div class="content-wrapper">
                ...
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            ...
                            <h1 class="m-0"> <box-icon name='credit-card' color='#e24141'></box-icon>
                            </h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
            ...
            <div class="content">
                <div class="container-fluid">
                    ...
                    <?php
                    include("../modelo/mdPago.php");
                    $pag = new Pago();

                    if (isset($_REQUEST['id'])) {
                        switch ($_REQUEST['id']) {
                            case 1:
                                $pag->inicializar($_REQUEST['numero_mesa'], $_REQUEST['cantidad'], $_REQUEST['disponibilidad'], $_REQUEST['hora']);
                                $mes->ingresarMesa();
                                break;
                            case 2:
                                $pag->listarPago();
                            ...
                            case 3:
                                if (isset($_POST['codigo'])) {
                                    $mes->eliminarMesa($_POST['codigo']);
                                } else {
                                    echo "Error: Falta el código de la mesa a eliminar.";
                                }
                                break;
                            case 5:

                                if (isset($_POST['id_mesa'])) {
                                    $mes->modificarMesa($_POST['id_mesa']);
                                } else {
                                    echo "Error: Falta el ID de la mesa a modificar.";
                                }
                                break;
                            case 6:
                                $mes->actualizarMesa($_POST['id_mesa'], $_POST['numero_mesa'], $_POST['cantidad'], $_POST['disponibilidad'], $_POST['hora']);
                                break;
                            default:
