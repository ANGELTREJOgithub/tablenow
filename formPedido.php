            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        ...
                        <h1 class="m-0"> <box-icon name='cart' color='#e24141'></box-icon></h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                    ...
                    <div id="agrupar">
                        ...
                        if (isset($_REQUEST["id"])) {
                            switch ($_REQUEST["id"]) {
                                case 1:
                        ?>
                                    <form action="../Controlador/ctrlPedido.php" method="post" id="registro-form" enctype="multipart/form-data">
                                        <label for="categoria">Ingrese el pedido de la mesa:</label>
                                        <?php
                                        include("../modelo/mdPedido.php");
                                        $ped = new Pedido();
                                        $ped->mostrarMesas();
                                        ?>
                                        <div class="error-message" id="categoria-error"></div>
                                        <input type="hidden" name="id" value="1">
                                        <!-- Agregar campo oculto para id_mesa -->
