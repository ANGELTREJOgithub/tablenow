                ...
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            ...
                            <h1 class="m-0"> <box-icon name='user-pin' type='solid' color='#df3f3f'></box-icon>
                            </h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        if (isset($_REQUEST['id'])) {
                            switch ($_REQUEST['id']) {
                                case 1:
                                    if (isset($_REQUEST['nombre'], $_REQUEST['apellidop'], $_REQUEST['apellidom'], $_REQUEST['correo'], $_REQUEST['contraseña'], $_REQUEST['telefono'], $_REQUEST['id_rol'])) {
                                        $usu->inicializar(
                                            $_REQUEST['id'],
                                            $_REQUEST['nombre'],
                                            $_REQUEST['apellidop'],
                                ...
                                case 3:
                                    if (isset($_REQUEST['confirmar'])) {
                                        $usu->eliminarUsuario($_REQUEST['codigo']);
                                    } else {
                                        if (isset($_REQUEST['codigo'])) {
                                            $usu->eliminarUsuario($_REQUEST['codigo']);
                                        } else {
                                            echo "Error: No se ha proporcionado el código del usuario";
                                        }
                                    }
                                    break;
                                default:
