        ...
        <div class="content-wrapper">
                ...
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            ...
                            <h1 class="m-0"><box-icon name='comment-dots' color='#e24141'></box-icon></h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
            ...
            <div class="content">
                <div class="container-fluid">
                    ...
                    <?php
                    include("../modelo/mdContacto.php");
                    $con = new Contacto();

                    if (isset($_REQUEST['id'])) {
                        switch ($_REQUEST['id']) {
                            case 1:
                                $con->inicializar($_REQUEST['nombre'], $_REQUEST['telefono'], $_REQUEST['correo'], $_REQUEST['tipo_contacto'], $_REQUEST['comentario']);
                                $con->ingresarComentario();
                                break;
                            case 2:
                                $con->listarComentarios();
                                break;
                            case 3:
                                if (isset($_POST['id_conta'])) {
                                    $con->borrarComentario($_POST['id_conta']);
                                } else {
