            ...
            <div class="content-wrapper">
                ...
                <div class="content">
                    <div class="container-fluid">
                        ...
                        <?php
                        include("../Modelo/modelrol.php");
                        $cur = new Rol();

                        if (isset($_REQUEST['id'])) {
                            switch ($_REQUEST['id']) {
                                case 1:
                                    $cur->inicializar(null, $_POST['descripcion']);
                                    $cur->ingresarRol();
                                    break;
                                case 2:
                                    $cur->listarRol();
                                ...
                                case 3:
                                    ...
                                    break;
                                case 4:
                                    $cur->modificarRol($_REQUEST['codigo']);
                                    break;
                                case 5:
                                    $cur->actualizarRol($_POST['codigo'], $_POST['descripcionNuevo'], $_POST['descripcionViejo']);
                                    break;
                            }
                        } else {
