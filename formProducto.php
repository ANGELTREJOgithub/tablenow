            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        ...
                        <h1 class="m-0"> <box-icon name='dish' type='solid' color='#e24141'></box-icon></h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                    ...
                    <div id="agrupar">
                        ...
                        if (isset($_REQUEST["id"])) {
                            switch ($_REQUEST["id"]) {
                                case 1:
                        ?>
                                    <form action="../Controlador/ctrlProducto.php" method="post" id="registro-form" enctype="multipart/form-data">
                                        <h2 class="titleprod">Añadir producto</h2>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="nombre" name="nombre" placeholder="Ingrese nombre del producto" required>
                                            <div class="error-message" id="nombre-error"></div>
                                        </div>
                                        <div class="form-group">
                                            <label for="descripcion">Descripción del producto:</label>
                                            <textarea id="descripcion" name="descripcion" cols="60" rows="5" required></textarea>
                                        ...
                                        <input class="modificar" type="submit" value="Agregar">
                                    </form>
                        <?php
                            }
                        }
