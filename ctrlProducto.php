            ...
            <div class="content">
                <div class="container-fluid">
                    ...
                    if (isset($_REQUEST["id"])) {
                        switch ($_REQUEST["id"]) {
                            case 1:
                                $pro->inicializar(addslashes(file_get_contents($_FILES['imagen']['tmp_name'])), $_REQUEST['nombre'], $_REQUEST['descripcion'], $_REQUEST['precio'],  $_REQUEST['id_cate']);
                                $pro->agregarProducto();
                                break;
                            case 2:
                                $pro->listarProducto();
                                break;
                            case 3:
                                $pro->borrarProducto($_REQUEST["nombrep"]);
                                break;
                            case 5:
